...
urlpatterns = [
    ...
    path('export/', views.export_to_excel_formulario, name='export_to_excel_formulario'),
    path('export_excel/', views.export_to_excel_servidores, name='export_to_excel_servidores'),
    path('export_apis/', views.export_Api_to_excel, name='export_apis'),  # Exportar datos de ApisYsubdominios a Excel
